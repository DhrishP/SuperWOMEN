...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>SuperWOMEN Chatbot</title>
        <meta
          name="description"
        ...
        <div className="flex-1 overflow-auto">
          <div className="mx-auto flex h-full w-full max-w-[750px] flex-col items-center px-3 pt-4 sm:pt-8">
            ...
            {apiKey.length === 51 ? (
              <div className="relative w-full mt-4">
                ...
                <input
                  ...
                  type="text"
                  placeholder="Queries regardings law of women safety ..."
                  value={query}
            ...
            {loading ? (
              ...
              <div className="mt-6 text-center text-lg">{`AI-powered search & chat for laws regarding women's safety.`}</div>
            )}
          </div>
        </div>
      </div>
